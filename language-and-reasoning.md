...
This is an example of a good argument. I have not seen anybody disagree with either the reasoning or the conclusion of the argument, and it's hard to see any practical-minded line of disagreement. One reason the argument is so strong is the simplicity and effectiveness of its structure, which is based on the *reductio ad absurdum* principle that is the basis of many good arguments.
